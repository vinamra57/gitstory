...
**UPDATES (11.08.2025): to run GitStory, head over to [run-commands-guide.md](run-commands-guide.md) and run GitStory on your chosen Git Repo. The following instructions will work when the GitStory team is able get GitStory builds to work and run on their end.**
