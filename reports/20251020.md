...
- Currently still exploring Figma and ways to make a mockup front-end
- Looking for inspiration at platforms with both a command-line interface and a desktop app, like GitHub
- Started reviewing HTML/CSS/JavaScript
  
#### <u>Plans and goals for next week</u>

- Plan to create a basic frontend that users can input commands into and respond with placeholder outputs by 10/27
