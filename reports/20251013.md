...
- *Section 2: Product Description*
    ...
    - <u>Response to issue:</u>
        - Changed Visualization Dashboard from being a stretch goal to a major feature, added details on commands associated with dashboard and how to achieve it technically
